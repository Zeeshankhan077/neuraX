...
class NeuraXComputeNode:
    ...
    async def _execute_in_sandbox(self, code: str, task_type: str) -> dict:
        """
        Execute task in ephemeral Docker sandbox with auto-destruct.
        
        Uses --rm flag for automatic container cleanup after execution.
        Container self-destructs after job completion or timeout.
        ...
        - Auto-destruct container (--rm flag)
        ...
        try:
            ...
            try:
                ...
                logger.info("🧩 Sandbox Destroyed Successfully (auto-destruct via --rm)")

...
// Connect to Render production server by default
// Override with VITE_SIGNALING_SERVER_URL environment variable
const SERVER_URL = import.meta.env.VITE_SIGNALING_SERVER_URL || 'https://neurax-1.onrender.com'
